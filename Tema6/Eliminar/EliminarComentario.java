...
public class EliminarComentario {
  public static void main(String[] args) {
   /* 
    ...
    try {
      BufferedReader lector = new BufferedReader(new FileReader("Tema6/Eliminar/Programa.java"));
      BufferedWriter escritor = new BufferedWriter(new FileWriter("Tema6/Elimiar/Prueba.java"));
