...
public class MusicOrganizer
{
    ...
    //Constructor de con el campo seconds
    public MusicOrganizer(int seconds) {
        this.seconds = seconds;
    }

    //Getters y Setters del campo seconds
    ...
    //Métodos para poder incrementar la duración de una pista
    public void incrementarPista(){

    }
    public void decrementarPista(){

    }
    

    //Metodo findLongTracks
    ...
    public ArrayList<Track> findLongTracks(){
        ArrayList<Track> resultado = new ArrayList<Track>();
        for (Track track : tracks) {
            if (cancion.getSeconds() > 240) {
    ...
    public Track findShort(){
        ...
        if (tracks.size() > 0) {
            resultado = tracks.get(0);

            for (int i = 1; i < tracks.size(); i++) {
                if (tracks.get(i).getSeconds() < resultado.getSeconds()) {
                    resultado = tracks.get(i);
                }
            }
            return resultado;
        }else{
